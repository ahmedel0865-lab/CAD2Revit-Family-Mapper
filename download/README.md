...
**[CAD2Revit-0.10.0.zip](CAD2Revit-0.10.0.zip)**: standalone Revit add-in for Revit 2022-2026 (no pyRevit needed).
...
3. Start Revit and click **Always Load**. A **CAD2Revit** tab appears.
